...
reqparse.add_argument('ephem_data', type=str, required=True,
                      help="No ephem_data provided.", location='json')
reqparse.add_argument('established_date', type=str, required=True,
                      help="No established date provided.", location='json')
reqparse.add_argument('proprietor', type=str, required=True,
                      help="No proprietor provided.", location='json')
reqparse.add_argument('astrd_diameter', type=float, required=True,
                      help="No ephem_data provided.", location='json')
reqparse.add_argument('astrd_surface_composition', type=str, required=True,
                      help="No ephem_data provided.", location='json')
...
class HotelList(Resource):
    ...
    def post(self):
        ...
        #TODO: Ensure all args are present or throw sane error.
        hotel = {
            'name': args['name'],
...
class Hotel(Resource):
    ...
    def put(self, id):
        ...
        #TODO: allow fields other than name and room counts to be updated
        args = self.reqparse.parse_args()
